export const IconAoVivo = `
<svg xmlns="http://www.w3.org/2000/svg" width="68" height="65" viewBox="0 0 68 66">
      <g id="Grupo_160" data-name="Grupo 160" transform="translate(1.46 0.082)">
        <text id="G" transform="translate(32.54 51.918)" fill="#3d3d3d" font-size="65" font-family="Liturgica-Medium, Liturgica" font-weight="500"><tspan x="-33.182" y="0">G</tspan></text>
      </g>
    </svg>`;

export const IconContribua = `
<svg xmlns="http://www.w3.org/2000/svg" width="68" viewBox="0 0 68 65">
  <text id="H" transform="translate(34 52)" fill="#3d3d3d" font-size="65" font-family="Liturgica-Medium, Liturgica" font-weight="500"><tspan x="-33.182" y="0">H</tspan></text>
</svg>`;
...
<svg xmlns="http://www.w3.org/2000/svg" width="68" viewBox="0 0 68 65">
  <text id="L" transform="translate(34 52)" fill="#3d3d3d" font-size="65" font-family="Liturgica-Medium, Liturgica" font-weight="500"><tspan x="-33.377" y="0">L</tspan></text>
</svg>`;
...
<svg xmlns="http://www.w3.org/2000/svg" width="68" viewBox="0 0 55 48">
  <text id="R" transform="translate(0 38)" fill="#3d3d3d" font-size="48" font-family="Liturgica-Medium, Liturgica" font-weight="500"><tspan x="0" y="0">R</tspan></text>
</svg>`;
